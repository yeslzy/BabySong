...
- (void)request{
    WS(ws);
    [[AFHTTPSupport shareAFHTTP] getHeaderHttpRequest3:@"http://1.hellozyj.sinaapp.com/music_list.json" param:nil time:13 baseController:self success:^(NSURLSessionDataTask *task, id responseObject) {
        ws.musicEntities = [MusicEntity arrayOfEntitiesFromArray:responseObject[@"data"]].mutableCopy;
